...
```shell
go get github.com/OMC-OrientalCoin/OMC-Chain/cmd/checkpoint-admin
```
...
*CHECKPOINT_HASH is obtained based on this [calculation method](https://github.com/OMC-OrientalCoin/OMC-Chain/blob/master/params/config.go#L251).*
