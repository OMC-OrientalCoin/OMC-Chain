...
import (
	...
	"github.com/OMC-OrientalCoin/OMC-Chain/crypto/signify"
	"github.com/OMC-OrientalCoin/OMC-Chain/internal/build"
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/OMC-OrientalCoin/OMC-Chain/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "-v", "github.com/OMC-OrientalCoin/OMC-Chain/mobile")
